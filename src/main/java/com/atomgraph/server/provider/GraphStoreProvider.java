...
import com.atomgraph.server.service.GraphStoreFactory;
...
public class GraphStoreProvider extends com.atomgraph.core.provider.GraphStoreProvider
{
    ...
    public GraphStore getGraphStore(Request request, ServletConfig servletConfig, MediaTypes mediaTypes, Dataset dataset, com.atomgraph.core.util.jena.DataManager dataManager)
    {
